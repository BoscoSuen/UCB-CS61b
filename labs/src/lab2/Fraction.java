...
class Fraction {
  ...
  private static int numberOfFractions = 0;    //every object uses it, initialize it, use "static"!
  ...
  public String toString() {
    int thisGcd = gcd(numerator, denominator);     //gcd: greatest common divisor
   ...
   */
  public void changeNumerator(int numerator_int) { // DO NOT CHANGE THIS SIGNATURE!
